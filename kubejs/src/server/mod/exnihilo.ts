import {MeshPresets, SieveRecipeBuilder} from "../lib/exnihilo/exnihilo_sieve";
import {ex_nihilo_mekanism, ex_nihilo_sequentia, ex_nihilo_thermal, rankine} from "../../common/ids";
import {rm_recipe} from "../lib/base/recipes";

export function setup_exnihilo_recipes(event: KRecipeEvent) {
    removal(event);
    overrides(event);
    create(event);
}
...
function removal(event: KRecipeEvent) {
    rm_recipe(event, ex_nihilo_sequentia('ens_emerald'))
    rm_recipe(event, ex_nihilo_sequentia('ens_diamond'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_aluminum_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_copper_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_gold_crushed_netherrack'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_gold_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_iron_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_iron_sand'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_lead_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_nickel_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_platinum_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_silver_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_tin_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_uranium_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_zinc_gravel'))
    rm_recipe(event, ex_nihilo_sequentia('ens_piece_osmium_gravel'))
    rm_recipe(event, ex_nihilo_mekanism('sieve/ens_piece_osmium_1'))
    rm_recipe(event, ex_nihilo_mekanism('sieve/ens_piece_osmium_2'))
    rm_recipe(event, ex_nihilo_mekanism('sieve/ens_piece_osmium_3'))
    rm_recipe(event, ex_nihilo_thermal('exnihilothermal:sieve/ens_cinnabar'))
    rm_recipe(event, ex_nihilo_thermal('exnihilothermal:sieve/ens_apatite'))
    rm_recipe(event, ex_nihilo_thermal('exnihilothermal:sieve/ens_niter'))
    rm_recipe(event, ex_nihilo_thermal('exnihilothermal:sieve/ens_sulfur'))
}
